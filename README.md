...
Først opret en ny mappe, med et navn så i ved hvad det er for en mappe.
Jeg har kaldt den for "CheckIn-CheckOut-system"
...
Hvis i har ændret noget i koden som f.eks. skrevet en WriteLine, tilføjet en klasse osv
skal i skrive: git add .  
i git bash'en (ja der skal være et punktum)
Efter det, kan i skrive en kommentar for at holde gruppen opdateret
over hvad i har ændret med denne kommando: git commit -m "Har oprettet en WriteLine" 
